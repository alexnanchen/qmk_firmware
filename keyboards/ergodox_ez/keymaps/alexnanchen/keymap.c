...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_ergodox_pretty(
    ...
    ______________, ______________, ______________, KC_LBRACKET,    KC_RBRACKET,    KC_TILD       , D_PRN_B       ,                                 D_BRK_B       , ______________, KC_PC_PASTE,    ______________, ______________, ______________, ______________,
