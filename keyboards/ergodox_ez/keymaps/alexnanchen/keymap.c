...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [PROG] = LAYOUT_ergodox(
    ...
    ______________, ______________, ______________, ______________, ______________, ______________, ______________,
    ______________, ______________, ______________, ______________, ______________, ______________, ______________,
                    ______________, KC_LEFT       , KC_RIGHT      , ______________, ______________, ______________,
    D_BRK_B       , ______________, ______________, ______________, ______________, ______________, ______________,
  ...
  [OTHER] = LAYOUT_ergodox(
    ...
    ______________, ______________, ______________, KC_DOWN       , ______________, ______________,
    ______________, ______________, ______________, ______________, ______________, ______________, ______________,
    ______________, ______________, ______________, ______________, ______________,
    ...
    ______________, ______________, ______________, C_CELA        , ______________, E_GRAVE       , TREMA,
                    ______________, S_QUOTE       , D_QUOTE       , ______________, E_AIGU        , A_GRAVE,
    ______________, ______________, ______________, ______________, ______________, ______________, ______________,
                                    ______________, ______________, ______________, ______________, ______________,
