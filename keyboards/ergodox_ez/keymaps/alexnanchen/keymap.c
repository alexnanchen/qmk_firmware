...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_ergodox_pretty(
    ...
    KC_GRAVE      ,    KC_Q,           KC_W,           KC_F,           LT(7,KC_P),     KC_B,           TG(6),                                          ______________,   KC_J,           KC_L,           KC_U,             KC_Y,           KC_SCOLON,      KC_BSLASH,
    KC_MINUS      ,    KC_A,           LT(2,KC_R),     LT(1,KC_S),     LT(3, KC_T),    LT(4,KC_G),                                                                       KC_M,           LT(2, KC_N),    LT(1,KC_E),       LT(3,KC_I),     KC_O,           ______________,
    KC_LSHIFT     ,    KC_Z,           KC_X,           LCTL_T(KC_C),   LALT_T(KC_D),   KC_V,           KC_LGUI,                                         KC_LGUI,         KC_K,           LALT_T(KC_H),   LCTL_T(KC_COMMA), KC_DOT,         KC_SLASH,       KC_RSHIFT,
    KC_CIRC       ,    KC_LCTRL,       ______________, KC_LEFT,        KC_RIGHT,                                                                                                         KC_UP,          KC_DOWN,          ______________, KC_LCTRL,       ______________,
                                                                                                    LCTL(KC_Y),     LALT(LCTL(KC_DELETE)),   KC_PGDOWN,    LCTL(KC_V),
                                                                                                                    LGUI(KC_L),              KC_PGUP,
                                                                                    KC_SPACE,       KC_ENTER,       KC_LCTRL,                KC_RCTRL,     KC_ENTER,     KC_BSPACE
  ),
  [1] = LAYOUT_ergodox_pretty(
    ______________, KC_F1,          KC_F2,          KC_F3,          KC_F4,            KC_F5,          KC_F6,                                          KC_F7       ,    KC_F8      , KC_F9         , KC_F10         , KC_F11        , KC_F12        , ______________,
    ______________, ______________, ______________, ______________, ______________, ______________, ______________,                                 ______________, ______________, ______________, KC_EQUAL       , ______________, ______________, ______________,
    ______________, KC_PERCENT    , ______________, ______________, KC_EXLM       , KC_AT         ,                                                                 KC_KP_MINUS   , KC_KP_ASTERISK, ______________ , KC_KP_PLUS    , ______________, ______________,
    ______________, ______________, ______________, ______________, ______________, ______________, ______________,                                 ______________, ______________, KC_SLASH      , ______________ , ______________, ______________, ______________,
    ______________, ______________, ______________, KC_HOME       , KC_END        ,                                                                                                 ______________, ______________ , ______________, ______________, ______________,
                                                                                                    ______________, ______________, ______________, ______________,
                                                                                                                    ______________, ______________,
                                                                                    KC_TAB        , ______________, ______________, ______________, ______________, KC_TAB
  ),
  [2] = LAYOUT_ergodox_pretty(
    ...
    ______________, ______________, ______________, KC_LCBR                 ,   KC_RCBR,        KC_AMPR       , D_BRC_B       ,                                     ______________, ______________, ______________, ______________, ______________, ______________, ______________,
    ______________, KC_HASH       , ______________, KC_LPRN                 ,   KC_RPRN,        KC_DLR        ,                                                                     ______________, ______________, ______________, ______________, ______________, ______________,
    ______________, ______________, ______________, KC_LBRACKET             ,   KC_RBRACKET,    KC_TILD       , D_PRN_B       ,                                     D_BRK_B       , ______________, ______________, ______________, ______________, E_AIGU        , ______________,
    ______________, ______________, ______________, ______________          ,   KC_CIRC    ,                                                                                                        ______________, ______________, ______________, ______________, ______________,
                                                                                                    ______________, ______________, ______________, ______________,
                                                                                                                    ______________, ______________,
  ...
  [3] = LAYOUT_ergodox_pretty(
    ...
    ______________, ______________, ______________, CH_CELA                 , ______________, ______________, ______________,                                       ______________, ______________, ______________, ______________, ______________, ______________, ______________,
    ______________, ______________, ______________, ______________          , ______________, ______________,                                                                       ______________, S_QUOTE       , D_QUOTE       , ______________, E_AIGU        , ______________,
    ______________, ______________, ______________, ______________          , ______________, ______________, ______________,                                       ______________, ______________, ______________, ______________, ______________, ______________, ______________,
