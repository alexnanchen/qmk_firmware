...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_ergodox_pretty(
    ...
    ______________, ______________, KC_PERCENT    , ______________, KC_EXLM       , KC_AT         ,                                                                 KC_KP_MINUS   , KC_KP_PLUS    , ______________, KC_KP_ASTERISK , ______________, ______________,
