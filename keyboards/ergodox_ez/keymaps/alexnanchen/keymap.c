...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [PUNCT] = LAYOUT_ergodox(
    ...
    ______________, ______________, ______________, ______________, Q_MARK        , ______________, ______________,
  ...
  [PROG] = LAYOUT_ergodox(
    ...
    D_BRK_B       , ______________, ______________, ______________, ______________, E_AIGU        , ______________,
                                    ______________, ______________, ______________, ______________, ______________,
  ...
  [OTHER] = LAYOUT_ergodox(
    ______________, ______________, ______________, ______________, ______________, ______________, ______________,
    ______________, ______________, ______________, CH_CELA       , ______________, ______________, ______________,
    ______________, ______________, ______________, ______________, ______________, ______________,
    ______________, ______________, ______________, ______________, ______________, ______________, ______________,
    ______________, ______________, ______________, ______________, ______________,
    ...
    ______________, ______________, ______________, ______________, ______________, ______________, ______________,
    ______________, ______________, ______________, ______________, ______________, ______________, ______________,
                    ______________, S_QUOTE       , D_QUOTE       , ______________, E_AIGU        , ______________,
    ______________, ______________, ______________, ______________, ______________, ______________, ______________,
                                    ______________, ______________, ______________, ______________, ______________,
  ...
  [FR] = LAYOUT_ergodox(
    KC_ESCAPE,       KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_AUDIO_VOL_DOWN,
    KC_GRAVE,        KC_Q,           KC_W,           KC_F,           LT(7,KC_P),     KC_B,           TG(6),
    KC_MINUS,        KC_A,           LT(2,KC_R),     LT(1,KC_S),     LT(3, KC_T),    LT(4,KC_G),
    KC_LSHIFT,       KC_Z,           KC_X,           LCTL_T(KC_C),   LALT_T(KC_D),   KC_V,           KC_LGUI,
    KC_CIRC ,        KC_LCTRL,       ______________, KC_LEFT,        KC_RIGHT,
    ...
    KC_AUDIO_VOL_UP,  KC_6,          KC_7,           KC_8,             KC_9,           KC_0,           KC_DELETE,
    ______________,   KC_J,          KC_L,           KC_U,             KC_Y,           KC_SCOLON,      KC_BSLASH,
                      KC_M,          LT(2, KC_N),    LT(1,KC_E),       LT(3,KC_I),     KC_O,           KC_TAB,
    KC_LGUI,          KC_K,          LALT_T(KC_H),   LCTL_T(KC_COMMA),  KC_DOT,        KC_SLASH,       KC_RSHIFT,
    /*                            */ KC_UP,          KC_DOWN,          ______________, KC_LCTRL,       ______________,
