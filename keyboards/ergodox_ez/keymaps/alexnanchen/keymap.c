...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_ergodox_pretty(
    ...
    KC_MINUS      ,    KC_A,           LT(2,KC_R),     LT(1,KC_S),     LT(3, KC_T),    LT(4,KC_G),                                                                       KC_M,           LT(3, KC_N),    LT(1,KC_E),       LT(2,KC_I),     KC_O,           KC_QUOTE,
    ...
    KC_CIRC       ,    KC_LCTRL,       ______________, KC_LEFT,        KC_RIGHT,                                                                                                         KC_UP,          KC_DOWN,          ______________, KC_LCTRL,       ______________,
                                                                                                    LCTL(KC_Y),     LALT(LCTL(KC_DELETE)),   KC_PGDOWN,    LCTL(KC_V),
                                                                                                                    LGUI(KC_L),              KC_PGUP,
                                                                                    KC_SPACE,       KC_TAB,         KC_LCTRL,                KC_RCTRL,     KC_ENTER,     KC_BSPACE
  ),
  ...
  [2] = LAYOUT_ergodox_pretty(
    ...
    ______________, ______________, ______________, KC_LCBR                 ,   KC_RCBR,        KC_AMPR       , D_BRC_B       ,                                 ______________, ______________, KC_PC_CUT,      ______________, ______________, ______________, ______________,
    ______________, KC_HASH       , ______________, KC_LPRN                 ,   KC_RPRN,        KC_DLR        ,                                                                 ______________, KC_PC_COPY,     ______________, ______________, ______________, ______________,
    ______________, ______________, ______________, KC_LBRACKET             ,   KC_RBRACKET,    KC_TILD       , D_PRN_B       ,                                 D_BRK_B       , ______________, KC_PC_PASTE,    ______________, ______________, E_AIGU        , ______________,
  ...
  [3] = LAYOUT_ergodox_pretty(
    ...
    ______________, ______________, ______________, CH_CELA                 , ______________, ______________, ______________,                                 ______________, ______________, ______________, KC_UP,          KC_PGDOWN,      ______________, ______________,
    ______________, A_GRV         , ______________, ______________          , ______________, ______________,                                                                 KC_HOME,        ______________, KC_DOWN,        KC_RIGHT,       E_AIGU         , ______________,
    ______________, ______________, ______________, ______________          , ______________, ______________, ______________,                                 ______________, ______________, ______________, ______________, ______________, ______________, ______________,
