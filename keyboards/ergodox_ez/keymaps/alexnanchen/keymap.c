...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_ergodox_pretty(
    ...
    ______________, KC_LCTRL,    ______________, KC_LEFT,        KC_RIGHT,                                                                                                       KC_UP,          KC_DOWN,        KC_LBRACKET,    KC_RBRACKET,    KC_CAPSLOCK,
  ...
  [1] = LAYOUT_ergodox_pretty(
    ...
    ______________, ______________, ______________, ______________, ______________, ______________, ______________,                                 ______________, KC_KP_PLUS,     ______________, ______________, ______________, ______________, ______________,
    ______________, ______________, ______________, ______________, ______________,   D_BRC_B     ,                                                                 KC_KP_MINUS,    D_BRK_B       , ______________, D_PRN_B       , KC_EQUAL,       ______________,
    ______________, ______________, ______________, ______________, ______________, ______________, ______________,                                 ______________, KC_SLASH,       ______________, ______________, ______________, KC_KP_ASTERISK, ______________,
  ...
  [2] = LAYOUT_ergodox_pretty(
    ...
    ______________, ______________, ______________, KC_LABK,        KC_RABK,                                                                                                        ______________, ______________, ______________, ______________, ______________,
                                                                                                    ______________, ______________, ______________, ______________,
                                                                                                                    ______________, ______________,
                                                                                    ______________, ______________, ______________, ______________, ______________, ______________
  ),
