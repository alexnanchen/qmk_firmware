...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_ergodox_pretty(
    ...
    KC_MINUS      ,    LT(4,KC_A),     LT(3,KC_R),     LT(1,KC_S),     LSFT_T(KC_T),   LT(5,KC_G),                                                                       KC_M,           LSFT_T(KC_N),   LT(1,KC_E),       LT(2,KC_I),     KC_O,           KC_QUOTE,
  ...
  [1] = LAYOUT_ergodox_pretty(
    ...
    ______________, ______________, KC_PERCENT    , ______________, KC_EXLM       , KC_AT         ,                                                                 ______________, KC_KP_PLUS    , ______________, KC_KP_ASTERISK , ______________, ______________,
    ______________, ______________, ______________, ______________, ______________, ______________, ______________,                                 ______________, ______________, KC_KP_MINUS   , ______________ , ______________, ______________, ______________,
  ...
  [2] = LAYOUT_ergodox_pretty(
    RESET,          ______________, ______________, ______________, ______________, ______________, D_BRC_B       ,                                 ______________, ______________, ______________, ______________, ______________, ______________, ______________,
    ______________, ______________, ______________, KC_LCBR,        KC_RCBR,        ______________, D_PRN_B       ,                                 ______________, ______________, KC_PC_CUT,      ______________, ______________, ______________, ______________,
    ______________, ______________, KC_HASH       , KC_LPRN,        KC_RPRN,        KC_DLR        ,                                                                 ______________, KC_PC_COPY,     ______________, ______________, ______________, ______________,
    ______________, ______________, ______________, KC_LBRACKET,    KC_RBRACKET,    ______________, D_BRK_B       ,                                 ______________, ______________, KC_PC_PASTE,    ______________, ______________, ______________, ______________,
