...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [PROG] = LAYOUT_ergodox(
    ...
    ______________, ______________, ______________, ______________, ______________, ______________, ______________,
    ______________, ______________, ______________, KC_UP         , KC_PGUP       , ______________, ______________,
  ...
  [OTHER] = LAYOUT_ergodox(
    ______________, ______________, ______________, ______________, ______________, ______________, ______________,
    ______________, ______________, KC_PGDOWN     , KC_UP         , ______________, ______________, ______________,
    ______________, ______________, KC_LEFT       , KC_RIGHT      , ______________, ______________,
    ______________, ______________, ______________, KC_DOWN       , ______________, ______________, ______________,
    ______________, ______________, ______________, ______________, ______________,
