...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_ergodox_pretty(
    ...
    KC_MINUS      ,    KC_A,           LT(2,KC_R),     LT(1,KC_S),     LSFT_T(KC_T),   LT(4,KC_G),                                                                       KC_M,           LSFT_T(KC_N),   LT(1,KC_E),       LT(2,KC_I),     KC_O,           KC_QUOTE,
  ...
  [1] = LAYOUT_ergodox_pretty(
    ...
    ______________, KC_PERCENT    , ______________, ______________, KC_EXLM       , KC_AT         ,                                                                 KC_KP_MINUS   , KC_KP_PLUS    , ______________, KC_KP_ASTERISK , ______________, ______________,
    ______________, ______________, ______________, KC_HOME       , KC_END        , ______________, ______________,                                 ______________, ______________, KC_SLASH      , ______________ , ______________, ______________, ______________,
