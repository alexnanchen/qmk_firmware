...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_ergodox_pretty(
    ...
    KC_MINUS      ,    LT(3,KC_A),     LT(2,KC_R),     LT(1,KC_S),     LSFT_T(KC_T),   LT(4,KC_G),                                                                       KC_M,           LSFT_T(KC_N),   LT(1,KC_E),       LT(2,KC_I),     KC_O,           KC_QUOTE,
  ...
  [2] = LAYOUT_ergodox_pretty(
    RESET,          ______________, ______________, ______________, ______________, ______________, D_BRC_B       ,                                 D_BRC_B       , ______________, ______________, ______________, ______________, ______________, ______________,
    ______________, ______________, ______________, KC_LCBR,        KC_RCBR,        KC_AMPR       , D_BRC_B       ,                                 D_BRC_B       , ______________, KC_PC_CUT,      ______________, ______________, ______________, ______________,
    ...
    ______________, ______________, ______________, KC_LBRACKET,    KC_RBRACKET,    KC_TILD       , D_BRC_B       ,                                 D_BRC_B       , ______________, KC_PC_PASTE,    ______________, ______________, ______________, ______________,
