...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_ergodox_pretty(
    ...
    ______________, ______________, ______________, KC_DQUO       , ______________, ______________, ______________,                                 ______________, ______________, KC_KP_PLUS   , KC_EQUAL      , KC_KP_ASTERISK, ______________, ______________,
    ______________, ______________, KC_QUOTE      , ______________, KC_MINUS      , ______________       ,                                                          ______________, KC_KP_MINUS   , ______________, ______________, ______________, ______________,
    ______________, ______________, ______________, ______________, KC_UNDS       , ______________, ______________,                                 ______________, ______________, KC_SLASH      , ______________, ______________, ______________, ______________,
  ...
  [2] = LAYOUT_ergodox_pretty(
    ...
    ______________, KC_PIPE,        ______________, KC_LCBR,        KC_RCBR,        KC_BSLASH,      D_PRN_B       ,                                 ______________, ______________, KC_PC_CUT,      ______________, ______________, ______________, ______________,
    ______________, ______________, ______________, KC_LPRN,        KC_RPRN,        KC_TILD,                                                                        ______________, KC_PC_COPY,     ______________, ______________, ______________, ______________,
    ______________, KC_GRAVE,       KC_TILD,        KC_LBRACKET,    KC_RBRACKET,    KC_EXLM,        D_BRK_B       ,                                 ______________, ______________, KC_PC_PASTE,    ______________, ______________, ______________, ______________,
